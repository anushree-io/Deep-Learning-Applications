import numpy as np
from tensorflow.keras.models import Sequential # sequence of input -> hidden -> outout
from tensorflow.keras.layers import SimpleRNN, Dense
from tensorflow.keras.utils import to_categorical # convert one type to another
